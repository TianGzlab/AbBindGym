...
DATASETS=(ABBind AbDesign SKEMPI)
MODES=(wt masked)
FOCUS_VALUES=(0 1)

RUNNER_DIR="$REPO_ROOT/zero_shot/modelzoo/esm3"
PY_SCRIPT="$RUNNER_DIR/compute_fitness_multi_pdb_esmc.py"
CACHE_BASE="${CACHE_BASE:-$CACHE_ROOT/esm3}"
RUN_GPU="$(abgym_resolve_run_gpu 1)"
