...
MODELS=("ZYMScott/antiberty")
DATASETS=(ABBind AbDesign SKEMPI BindingGYM)
MODES=(wt masked)
FOCUS_VALUES=(0 1)

RUNNER_DIR="$REPO_ROOT/zero_shot/modelzoo/antiberty"
PY_SCRIPT="$RUNNER_DIR/compute_fitness_multi_pdb.py"
CACHE_BASE="${CACHE_BASE:-$CACHE_ROOT/AntiBERTy}"
