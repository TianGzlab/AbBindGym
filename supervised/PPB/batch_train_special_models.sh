#!/usr/bin/env bash
# Batch training for PPB special models.
...
DATASET_NAME="${DATASET_NAME:-PPB_with_clusters}"
...
echo "===================================================================="
echo "PPB Special Models Training"
echo "===================================================================="
...
run_one() {
  ...
  LOG_FILE="$LOG_DIR/${STAMP}_ppb_${SPLIT_STRATEGY}_${SAFE_MODEL}.log"
...
echo
echo "===================================================================="
echo "PPB Special-Model Training Complete"
echo "===================================================================="
