...
DATASET_NAME="${DATASET_NAME:-AbELA_Q_with_clusters}"
...
echo "===================================================================="
echo "AbELA-Q Special Models Training"
echo "===================================================================="
...
run_one() {
  ...
  LOG_FILE="$LOG_DIR/${STAMP}_abela_${SPLIT_STRATEGY}_${SAFE_MODEL}.log"
...
echo
echo "===================================================================="
echo "AbELA-Q Special-Model Training Complete"
echo "===================================================================="
