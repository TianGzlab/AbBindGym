#!/usr/bin/env bash
# Batch evaluation for SabDab special models.
...
DATASET_NAME="SabDab_with_clusters"
...
SPLITS_FILE="${SPLITS_FILE:-$REPO_ROOT/data/supervised/clustered_benchmarks/SabDab/splits/Dunbar2014_SabDab_seqcluster_k5_seed314.json}"
...
echo "===================================================================="
echo "SabDab Special-Model Evaluation"
echo "===================================================================="
...
echo "===================================================================="
echo "SabDab Batch Evaluation Complete"
echo "===================================================================="
